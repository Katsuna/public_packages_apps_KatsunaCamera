...
public class SizeUtil {
    ...
    public static Size getCaptureSize(List<Size> choices, Comparator<Size> comparator) {
    ...
    public static Matrix getMatrix(int viewWidth, int viewHeight, Size previewSize, int rotation) {
